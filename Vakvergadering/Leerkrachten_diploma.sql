WITH Overzicht AS (
	...
	left join Scholen AS SC ON SC.ID = IT.IS_SCHOOL_FK
...
SELECT 
	*,
	KL_CODE + '-' + CAST(SJ_ID as varchar(15)) + '-' + CAST(IV_ID as varchar(15)) + '-' + CAST(IS_ID as varchar(15)) AS [koppeling leerkrachten]	
FROM
	Overzicht
