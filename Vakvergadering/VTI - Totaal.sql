...
from [VTI - Vertrekpunt] VP -- 6616
inner join [VTI - Eigen aan leerling] EL on VP.LL_ID = EL.LL_ID -- 6616 
inner join [VTI - Eigen aan loopbaanitem] ES on VP.LL_ID = ES.LL_ID -- 54121
inner join [VTI - Namen Leerlingen] NL on NL.LL_ID = EL.LL_ID --54121
left join [VTI - Schoolse achterstand] SA on SA.LB_ID = ES.LB_ID -- 54121
left join [VTI - Laatst ingelogd] LI on VP.LL_ID = LI.LL_ID -- 54121
left join [VTI - Adressen] AD on AD.LL_ID = VP.LL_ID -- 54121
left join [VTI - Afwezigheid] AF on ES.LB_ID = AF.LB_ID -- 54121
left join [VTI - Instroom] INS on ES.LB_ID = INS.LB_ID -- 54121
left join [VTI - Internaat] IT on IT.LL_ID = VP.LL_ID AND IT.SJ_ID = ES.SJ_ID  -- 54121
